    ...
    <div className="w-[100%]">
      {modalstatus ? (
        <div className="w-[100%] lg:w-[77%] h-screen blur-[0.2px] bg-[#000000ad] flex justify-center items-center absolute z-10">
          <div className="w-[90%] h-[70vh] rounded bg-[white]">
            <div className="text-[red] pt-2 pb-1 text-[20px]" align="center">
              ...
              <div
                className="w-[100%] h-[49vh] flex flex-col items-center overflow-x-auto"
                align="center"
              >
          ...
          <div className="w-[100%] flex gap-x-5">
            ...
            >
              <button
                ...
                className="text-[28px] text-[#f95005] mt-2"
              >
                  ...
                  <div className="w-[95%] flex flex-col lg:flex-row">
                    ...
                    <div className="w-[100%] lg:w-[20%] flex flex-col items-center justify-center">
                      <button
                        ...
                        className="w-[95%] bg-[#209E24] border-2 border-[#209E24] text-[#fff] text-[18px] font-semibold  hover:bg-[#f5f7f8] hover:text-[#209E24] rounded py-2 transition-all duration-300"
                      >
                        Approve
                      </button>
                      <button className="w-[95%] bg-[#FF0000] border-2 mb-5 mt-2 lg:mb-0 border-[#FF0000] text-[#fff] text-[18px] font-semibold  hover:bg-[#f5f7f8] hover:text-[#FF0000] rounded py-2 transition-all duration-300">
                        Reject
                      </button>
                    </div>
                  </div>
